...
**Important Notes:**
- 🔧 **Run from source for the latest version.** Pre-built binaries are available for Windows (v1.1.1) and macOS/Linux (v1.0.0), but running from source ensures you always have the newest features and fixes.
