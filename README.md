...
**Important Notes:**
- 🔧 **Run from source for the latest version.** Pre-built binaries are available for Windows [v1.2.5] and macOS/Linux (v1.0.0), but running from source ensures you always have the newest features and fixes.
...
<p align="center">
  <img src="assets/drawer_example.gif" alt="IMDER Drawer Mode" width="256"/>
</p>
